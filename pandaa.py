...
sheet = pd.read_excel(r"notas_planilha_modelo.xlsx", skiprows=(0,1))    #pegar o caminho do seu pc
...
def calcular_nota(x):
    ...
    nota_necessaria_GS = round(((media_s2 - media_cp_ch) /0.6), 2) # Nota necessária na GS para ser aprovado no 2o semestre
